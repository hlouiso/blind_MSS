 ...
 *   chain step : pk_seed(16) || 0x00 || in(16)     || chain_idx(1) || pos(1)
 *   tree node  : pk_seed(16) || 0x01 || level(1) || index(2 LE) || left(16) || right(16)
 *   public key : pk_seed(16) || 0x01 || pk_hash[0] || ... || pk_hash[LEN-1]   (16B each)
 *
...
/* SHA256(pk_seed || 0x02 || nonce || message), full 32-byte digest. */
...
/* trunc16(SHA256(pk_seed || 0x00 || in || chain_idx || pos)). */
...
/* trunc16(SHA256(pk_seed || 0x01 || level || index || left || right)). */
...
/* trunc16(SHA256(pk_seed || 0x01 || pk_hash[0] || ... || pk_hash[LEN-1])). */
